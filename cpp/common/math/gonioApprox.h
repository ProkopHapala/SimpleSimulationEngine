...
inline void cos_sin( double x_, double& ca, double& sa ){
    ...
    //constexpr const double inv2pi = 1/M_PI;
    ...
    // Taylor
    //c=    1                  +xx*(-0.3084251375340424  +xx*(0.01585434424381549 +xx*(-0.00032599188692739   +xx*(3.590860448591509e-06 +xx*(-2.461136950494199e-08 +xx*(1.150115912797405e-10 ))))));
    //s= x*(0.7853981633974483 +xx*(-0.08074551218828077 +xx*(0.00249039457019272 +xx*(-3.657620418217724e-05 +xx*(3.133616890378121e-07 +xx*(-1.7572476734434e-09   +xx*(6.948453273886625e-12 )))))));

    //c=    1                  +xx*(-0.3084251375340424  +xx*(0.01585434424381549 +xx*(-0.00032599188692739   +xx*(3.590860448591509e-06 ))));
    //s= x*(0.7853981633974483 +xx*(-0.08074551218828077 +xx*(0.00249039457019272 +xx*(-3.657620418217724e-05 +xx*(3.133616890378121e-07 )))));

    c=    1                  +xx*(-0.3084251375340424  +xx*(0.01585434424381549 +xx*(-0.00032599188692739   )));
    s= x*(0.7853981633974483 +xx*(-0.08074551218828077 +xx*(0.00249039457019272 +xx*(-3.657620418217724e-05 ))));

    //c=    1                  +xx*(-0.3084251375340424  +xx*(0.01585434424381549 ));
    //s= x*(0.7853981633974483 +xx*(-0.08074551218828077 +xx*(0.00249039457019272 )));

    // Hermite Spline
    //c = 1 +x *(-0.2928932188134524 );
    //c = 1 +xx*(-0.3233192891705614 +x *( 0.03042607035710909 )));
    //c = 1 +xx*(-0.3084251375340424 +x *(-0.0003048126919296124 +x*( 0.01677931118851816   +x*(-0.0009425797760003185 )))));
    //c = 1 +xx*(-0.3084251375340424 +xx*( 0.0158509955042625    +x*( 1.349112526938256e-05 +x*(-0.0003464455174153613 +x*(1.387760849524966e-05 )))));
    //c = 1 +xx*(-0.3084251375340424 +xx*( 0.01585434424381549   +x*(-2.291289236122651e-08 +x*(-0.0003258767594425116 +x*(-2.318310845517146e-07 +x*(3.825060483908516e-06 +x*(-1.190802214612319e-07 )))))));
    //s = x*(0.7071067811865476 );
    //s = x*(0.7853981633974483 +x *(-0.004836350505049491 +x *(-0.0734550317058511 )));
    //s = x*(0.7853981633974483 +xx*(-0.08085214383711214  +x *( 0.0002851727473718313  +x*(0.00227558887883772 ))));
    //s = x*(0.7853981633974483 +xx*(-0.08074551218828077  +x *(-1.218688513660027e-06  +x*(0.002494973293380554  +x*(-6.121116889801215e-06 +x*(-3.350351064668189e-05 ))))));
    //s = x*(0.7853981633974483 +xx*(-0.08074551218828077  +xx*( 0.002490386024409652   +x*(4.107407081122005e-08 +x*(-3.665335412916804e-05 +x*( 6.87480530281448e-08 +x*(2.874851023904057e-07 )))))));
    //if(ix&1){ca=-s;sa=c;}else{ca=c;sa=s;};
    //if(ix&4){sa=-sa;ca=1-ca;};
    rot_csa( c,s, c,s );
    rot_csa( c,s, c,s );
    rot_csa( c,s, c,s );
    //rot_csa( c,s, c,s );
