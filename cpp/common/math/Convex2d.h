...
class Convex2d{
    ...
    bool funcking_empty1( const Line2d& line, Convex2d& left                  );
    bool funcking_empty2( const Line2d& line, Convex2d& left, Convex2d& right );
    bool funcking_empty3( const Line2d& line, Convex2d* left, Convex2d* right );
