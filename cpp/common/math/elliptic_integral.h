...
/* Complete elliptic integrals (angle argument) */
...
/* Complete elliptic integrals (k or m argument) */
...
/* Incomplete elliptic integrals (angle + parameter) */
...
void   elliptic_inc_pia_values ( int *n_data, double *phi, double *n, double *a, double *pia );

/* Incomplete elliptic integrals (phi + k/m) */
...
void   elliptic_inc_pik_values ( int *n_data, double *phi, double *n, double *k, double *pik );

double elliptic_inc_pim ( double phi, double n, double m );
void   elliptic_inc_pim_values ( int *n_data, double *phi, double *n, double *m, double *pim );

/* Jacobi elliptic functions */
double jacobi_sn ( double u, double m );
void   jacobi_sn_values ( int *n_data, double *u, double *a, double *k, double *m, double *fx );

double jacobi_cn ( double u, double m );
void   jacobi_cn_values ( int *n_data, double *u, double *a, double *k, double *m, double *fx );

double jacobi_dn ( double u, double m );
void   jacobi_dn_values ( int *n_data, double *u, double *a, double *k, double *m, double *fx );
