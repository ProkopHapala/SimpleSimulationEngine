...
class GridIndex2D{ public:
    ...
    inline bool   innerIndex( Vec2i ip)const{ return (ip.x>0)&&(ip.x<(n.x-1))&&(ip.y>0)&&(ip.y<(n.y-1)); }
    inline Vec2i  wrap_index( Vec2i ip)const{ return (Vec2i){ wrap_index_fast(ip.a,n.a),  wrap_index_fast(ip.b,n.b) }; }
    inline Vec2i  clamp_index( Vec2i ip)const{ return (Vec2i){clamp_index_fast(ip.a,n.a), clamp_index_fast(ip.b,n.b) }; }
