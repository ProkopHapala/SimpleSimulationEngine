...
class DynamicOpt{
    ...
    void bindArrays( int n_, double * pos_, double * vel_, double * force_, double * invMasses_=NULL ){
	//void bindArrays( int n_, double * pos_, double * vel_, double * force_, double * invMasses_ ){
