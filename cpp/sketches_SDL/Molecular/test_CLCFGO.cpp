...
TestAppCLCFSF::TestAppCLCFSF( int& id, int WIDTH_, int HEIGHT_ ) : AppSDL2OGL_3D( id, WIDTH_, HEIGHT_ ) {
    ...
    */
    ...
    //double DEBUG_scale = 2.50662827463*M_SQRT2;
    //double DEBUG_scale = sqrt(1/(Gauss::sqnorm3Ds(1)*Gauss::sqnorm3Ds(1)*Gauss::sqnorm3Ds(1)));
    //double DEBUG_scale = 1;
    //double DEBUG_scale = sqrt(1/Gauss::norm3Ds(1));
    ...
    gridNumIntegral( nint, 0.2, 6.0, Lmax, line_IrhoGrid->ys, func1, func2 );
