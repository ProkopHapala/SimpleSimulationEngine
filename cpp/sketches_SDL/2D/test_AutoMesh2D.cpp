...
/// @file @brief This demo showcases `AutoMesh2D.h`, a library for automatic 2D mesh generation. It allows the user to interactively define input points with mouse clicks, then visualizes the resulting mesh, demonstrating the algorithm's ability to create a tessellation of the 2D space. The mesh can be regenerated by pressing the `SPACE` key.
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
#include <vector>
