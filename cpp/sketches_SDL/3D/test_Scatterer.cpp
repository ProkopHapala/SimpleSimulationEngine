...
void drawObstacles( TriangleRayTracer& rad, bool filled ){
...
void drawElements( TriangleRayTracer& rad ){
...
void drawElements2( TriangleRayTracer& rt, double elementSize ){
    glBegin(GL_LINES);
...
TestAppRadiosity::TestAppRadiosity( int& id, int WIDTH_, int HEIGHT_ ) : AppSDL2OGL_3D( id, WIDTH_, HEIGHT_ ) {
    ...
    //solver.trinagleToElements2( 0.5, (Triangle3D){-1.0,-1.0,5.0,   1.0,-1.0,5.0,    0.0,1.0,5.0},  0 );
    //solver.trinagleToElements2( 0.5, , 1 );

    solver.addTriangle( (Triangle3D){-1.0,-1.0,5.0,   1.0,-1.0,5.0,    0.0,1.0,5.0},  0.5, true );
    solver.addTriangle( (Triangle3D){-1.0,-1.0,10.0,  1.0,-1.0,10.0,   0.0,1.0,10.0}, 0.5, true );
...
void TestAppRadiosity::draw(){
    ...
    //DEBUG
    //drawPanels( solver.elements.size(), &solver.elements[0],  0, 0.1, 10.0 );
	//drawPanels( solver.elements.size(), &solver.elements[0],  solver.vals, 0.1, 10.0 );
