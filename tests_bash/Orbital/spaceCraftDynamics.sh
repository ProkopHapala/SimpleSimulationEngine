...
#./$name.x -method 2  -dt 0.01 -double -fix 2 -shape 2,50 -perframe 10  -G 0.0,-9.81,0.0  
#./$name.x -method 2  -dt 0.05 -double -fix 2 -shape 2,10 -perframe 100 -G 0.0,-9.81,0.0
...
./$name.x -method 12  -dt 0.01 -omega 0.0,0.0,0.05 -s data/ship_ICF_marksman_2.lua  -perframe 10  -nsolve 10 -bmix 3,0.8
