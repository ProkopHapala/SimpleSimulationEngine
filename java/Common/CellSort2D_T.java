...
public class CellSort2D_T<T extends GetXY> extends CellSort {
  double dcell;
  double step;
  int nx,ny;
  T[] army;
  ...
  public  CellSort2D_T( T[] army_, int w,int h, int dcell_ ){ super( (w/dcell_)*(h/dcell_), army_.length ); dcell=dcell_; step=1./dcell; nx=(w/dcell_); ny=(h/dcell_); army=army_;  }
