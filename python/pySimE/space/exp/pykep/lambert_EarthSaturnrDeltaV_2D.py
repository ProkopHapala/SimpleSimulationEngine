...
for tt1 in range(tt1min,tt1max,step):
	...
	dvMapSaturn .append(dvRowM)
dvMapEarth = array( dvMapEarth )
dvMapSaturn  = array( dvMapSaturn  )
...
subplot (3,1,1)
title('Total Earth to Saturn delta-v [km/s]')
FF = transpose((dvMapEarth+dvMapSaturn)/1000)
...
subplot (3,1,3)
title('Saturn arrival delta-v [km/s]')
FF = transpose(dvMapSaturn/1000)
