...
THREE.TrackballControls = function ( object, domElement ) {
	...
	this.rotateCamera = ( function() {
		...
		return function rotateCamera() {
            //window.alert("rotateCamera");
            //document.write("rotateCamera");
			...
			if ( angle ) {
				...
				//console.log( "angle "+ angle +"quaternion "+quaternion.x+" "+quaternion.y+" "+quaternion.z+" "+quaternion.w);
	...
	function mousemove( event ) {
		...
		if ( _state === STATE.ROTATE && ! _this.noRotate ) {
			_movePrev.copy( _moveCurr );
			_moveCurr.copy( getMouseOnCircle( event.pageX, event.pageY ) );
			//console.log("from "+_movePrev.x+" "+_movePrev.y+" to  "+ _moveCurr.x+" "+_moveCurr.y);
		} else if ( _state === STATE.ZOOM && ! _this.noZoom ) {
